...
public class Paciente {
	...
	public static void relatorio() {
		System.out.println("Quantidade de pacientes: " + Paciente.qtdpacientes);
		System.out.println("Média de idade dos homens: " + Paciente.mediaidadehomem);
		...
		System.out.println("A quantidade de pessoa com idade entre 18 e 25 anos: "
				+ Paciente.pessoas);
		System.out.println("Nome do paciente mais velho: " + Paciente.nomemaisvelho);
		System.out.println("Nome da paciente mais baixa: " + Paciente.nomemaisbaixa);
	}
